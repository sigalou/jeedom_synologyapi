...
<div class="row row-overflow">
				...
				//echo "<br>".$eqLogic->getHumanName(true, true);
					if ($eqLogic->getConfiguration('devicetype') == "1") {
						...
						if ($eqLogic->getConfiguration('type') == "cmd") {
								...
								$compteurcmd--; //pour eviter de compter Refresh
								$opacity = ($eqLogic->getIsEnable()) ? '' : 'disableCard';
								echo '<div class="eqLogicDisplayCard cursor '.$opacity.'" data-eqLogic_id="' . $eqLogic->getId() . '">';
								//echo '<img class="lazy" src="plugins/synologyapi/plugin_info//synologyapi_dev.png" style="min-height:75px !important;" />';
	...
	<div class="col-lg-12 eqLogic" style="display: none;">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li id="OngletInfo" role="presentation" class="active"><a href="#OngletInfo" aria-controls="home" role="tab" data-toggle="tab"><i class="fas fa-exchange-alt"></i> {{API}}</a></li>
<!--			<li id="Onglet_eqlogictab2" role="presentation" ><a href="#eqlogictab2" aria-controls="home" role="tab" data-toggle="tab"><i class="fas fa-tachometer-alt"></i> {{Informations Récupérées}}</a></li>-->
			<li id="OngletCmd" role="presentation" class="active"><a href="#OngletCmd" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> {{Commandes}}</a></li>
		</ul>
		<!---------------- Onglet ListeAPI --------------  
		...
		<!---------------- Onglet Equipement ---------------->  
			<div role="tabpanel" class="tab-pane active" id="OngletInfo">
				<br/>
		...
		<!---------------- Onglet OngletCmd ---------------->  
			<div role="tabpanel" class="tab-pane" id="OngletCmd">
				<form class="form-horizontal">
					<fieldset>

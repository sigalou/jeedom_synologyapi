...
<div class="row row-overflow">
	...
	<div class="col-lg-12 eqLogic" style="display: none;">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li id="Onglet_eqlogictab" role="presentation" class="active"><a href="#eqlogictab" aria-controls="home" role="tab" data-toggle="tab"><i class="fas fa-exchange-alt"></i> {{API}}</a></li>
			...
			<li id="Onglet_groupeCommandes" role="presentation" class="active"><a href="#groupeCommandes" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> {{Commandes}}</a></li>
		</ul>
		<!---------------- Onglet ListeAPI --------------  
		...
		<!---------------- Onglet groupeCommandes ---------------->  
			<div role="tabpanel" class="tab-pane" id="groupeCommandes">
				<form class="form-horizontal">
					<fieldset>

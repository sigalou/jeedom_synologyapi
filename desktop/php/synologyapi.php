	...
	foreach ($eqLogics as $eqLogic) {
		//echo "<br>".$eqLogic->getHumanName(true, true);
			if ($eqLogic->getConfiguration('devicetype') == "1") {
				if ($eqLogic->getConfiguration('type') == "all") {
				...
				echo '<br>';
				echo '<span class="name" >Liste des API</span>';
				echo '</div>';
				}	else {			
				$opacity = ($eqLogic->getIsEnable()) ? '' : 'disableCard';
				echo '<div class="eqLogicDisplayCard cursor '.$opacity.'" data-eqLogic_id="' . $eqLogic->getId() . '">';
...
<div class="col-lg-12 eqLogic" style="display: none;">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li id="OngletCommandes" role="presentation"><a href="#commandtab" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> {{Commandes}}</a></li>
